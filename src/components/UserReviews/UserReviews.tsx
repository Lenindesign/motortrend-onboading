...
export const UserReviews: React.FC<UserReviewsProps> = ({ 
  ...
  const vehicleHeaderStyle: React.CSSProperties = { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 'var(--spacing-2, 16px)', flexWrap: 'wrap', gap: isMobile ? '12px' : 'var(--spacing-2, 16px)', flexDirection: isMobile ? 'column' : 'row' };
  const vehicleNameStyle: React.CSSProperties = { fontFamily: 'var(--font-heading, Poppins, sans-serif)', fontWeight: 600, fontSize: isMobile ? '20px' : 'var(--font-size-lg, 18px)', lineHeight: '1.167em', color: 'var(--color-neutrals-1, #141416)', margin: 0, alignSelf: isMobile ? 'flex-start' : undefined };
  const writeReviewBtnStyle: React.CSSProperties = { display: 'flex', alignItems: 'center', gap: 'var(--spacing-1, 8px)', padding: isMobile ? '10px 20px' : 'var(--spacing-component-md, 12px) var(--spacing-3, 24px)', backgroundColor: isWriteReviewHovered ? 'var(--color-neutrals-2, #23262F)' : 'var(--color-neutrals-2-5, #282a30)', color: 'var(--color-white, #FFFFFF)', border: 'none', borderRadius: 'var(--border-radius-md, 8px)', fontFamily: 'var(--font-heading, Poppins, sans-serif)', fontWeight: 600, fontSize: isMobile ? '14px' : 'var(--font-size-base, 16px)', cursor: 'pointer', transition: 'background-color var(--transition-fast, 150ms ease-in-out)', width: isMobile ? '100%' : undefined, justifyContent: isMobile ? 'center' : undefined };
  const ratingSectionStyle: React.CSSProperties = { display: 'flex', gap: isMobile ? '16px' : 'var(--spacing-3, 24px)', marginBottom: 'var(--spacing-2, 16px)', alignItems: isMobile ? 'stretch' : 'flex-end', flexDirection: isMobile ? 'row' : 'row', width: '100%' };
  const ratingCardStyle: React.CSSProperties = { display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: isMobile ? 'auto' : '189px', flex: isMobile ? '0 0 auto' : undefined, height: isMobile ? 'auto' : '173px', backgroundColor: 'var(--color-neutrals-2-5, #2c2f38)', borderRadius: 'var(--border-radius-md, 8px)', padding: isMobile ? '16px' : '20px 12px 12px 12px', gap: isMobile ? '8px' : 0, position: 'relative' };
  const ratingContentStyle: React.CSSProperties = { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: isMobile ? '6px' : 'var(--spacing-2, 16px)', flex: 1, justifyContent: 'center', padding: 0 };
  const starsDisplayStyle: React.CSSProperties = { display: 'flex', alignItems: 'center', gap: isMobile ? '2px' : 'var(--spacing-gap-xs, 4px)' };
  const starIconStyle: React.CSSProperties = { width: isMobile ? '20px' : '24px', height: isMobile ? '20px' : '24px', objectFit: 'contain', flexShrink: 0 };
  const ratingLabelStyle: React.CSSProperties = { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: isMobile ? '6px' : 'var(--spacing-1, 8px)', flexWrap: 'wrap' };
  const ratingLabelTextStyle: React.CSSProperties = { fontFamily: 'var(--font-heading, Poppins, sans-serif)', fontWeight: 600, fontSize: isMobile ? '11px' : 'var(--font-size-xs, 12px)', lineHeight: '1.143em', color: 'var(--color-white, #FFFFFF)' };
  ...
  const distributionStyle: React.CSSProperties = { flex: 1, display: 'flex', alignItems: 'flex-end', position: 'relative', zIndex: 0, minWidth: 0 };
  const distributionChartStyle: React.CSSProperties = { display: 'flex', alignItems: 'flex-end', gap: isMobile ? '6px' : 'var(--spacing-1, 8px)', width: '100%', height: isMobile ? '100px' : '173.31px', paddingLeft: isMobile ? '8px' : '16px' };
  ...
  const barStarStyle: React.CSSProperties = { width: isMobile ? '14px' : '16px', height: isMobile ? '14px' : '16px', marginBottom: isMobile ? '4px' : '6px', objectFit: 'contain' };
  ...
  const barLabelStyle: React.CSSProperties = { fontFamily: 'var(--font-heading, Poppins, sans-serif)', fontWeight: 600, fontSize: isMobile ? '14px' : 'var(--font-size-md, 18px)', lineHeight: '1.556em', color: 'var(--color-neutrals-2, #23262F)', marginTop: isMobile ? '4px' : '6px' };
  ...
  const recentHeaderStyle: React.CSSProperties = { display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: isMobile ? '12px' : 'var(--spacing-2, 16px)', marginTop: 'var(--spacing-3, 24px)', paddingTop: 'var(--spacing-2, 16px)', marginBottom: 'var(--spacing-2, 16px)', flexDirection: 'column', borderTop: '1px solid var(--color-neutrals-6, #E6E8EC)' };
  const recentTitleStyle: React.CSSProperties = { fontFamily: 'var(--font-heading, Poppins, sans-serif)', fontWeight: 600, fontSize: isMobile ? '18px' : 'var(--font-size-lg, 18px)', lineHeight: '1.167em', color: 'var(--color-neutrals-1, #141416)', margin: 0 };
  const recentHeaderRightStyle: React.CSSProperties = { display: 'flex', gap: isMobile ? '8px' : 'var(--spacing-2, 16px)', width: '100%', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' };
  const recentCountStyle: React.CSSProperties = { fontFamily: 'var(--font-body, Geist, sans-serif)', fontSize: isMobile ? '14px' : 'var(--font-size-base, 16px)', lineHeight: '1.333em', color: 'var(--color-neutrals-2, #23262F)' };
  const sortDropdownWrapperStyle: React.CSSProperties = { position: 'relative', display: 'flex', alignItems: 'center', gap: 'var(--spacing-1, 8px)', flex: isMobile ? '0 0 auto' : undefined };
  const sortLabelStyle: React.CSSProperties = { fontFamily: 'var(--font-body, Geist, sans-serif)', fontSize: isMobile ? '13px' : 'var(--font-size-base, 16px)', lineHeight: '1.333em', color: 'var(--color-neutrals-2, #23262F)', margin: 0 };
  const sortDropdownStyle: React.CSSProperties = { position: 'relative', display: 'flex', alignItems: 'center', gap: 'var(--spacing-1, 8px)', padding: isMobile ? '6px 10px' : 'var(--spacing-1, 8px) var(--spacing-component-md, 12px)', backgroundColor: isSortDropdownHovered ? 'var(--color-neutrals-8, #FCFCFD)' : 'var(--color-white, #FFFFFF)', border: `1px solid ${isSortDropdownHovered ? 'var(--color-neutrals-4, #6E7481)' : 'var(--color-neutrals-5, #B1B5C3)'}`, borderRadius: 'var(--border-radius-md, 8px)', cursor: 'pointer', transition: 'all var(--transition-fast, 150ms ease-in-out)', minWidth: isMobile ? '90px' : '120px', justifyContent: 'space-between' };
  const sortSelectedStyle: React.CSSProperties = { fontFamily: 'var(--font-body, Geist, sans-serif)', fontSize: isMobile ? '13px' : 'var(--font-size-sm, 14px)', fontWeight: 500, color: 'var(--color-neutrals-2, #23262F)', flex: 1, textAlign: 'left' };
  ...
  const sortDropdownMenuStyle: React.CSSProperties = { position: 'absolute', top: '100%', right: 0, marginTop: 'var(--spacing-1, 8px)', backgroundColor: 'var(--color-white, #FFFFFF)', border: '1px solid var(--color-neutrals-5, #B1B5C3)', borderRadius: 'var(--border-radius-md, 8px)', boxShadow: 'var(--shadow-lg, 0 10px 25px rgba(0,0,0,0.1))', zIndex: 1000, minWidth: '160px', overflow: 'hidden', animation: 'userReviewsFadeIn 0.2s ease-in-out' };
  const getSortOptionStyle = (option: string, isActive: boolean): React.CSSProperties => ({ width: '100%', padding: isMobile ? '8px 12px' : '10px var(--spacing-2, 16px)', background: isActive ? 'var(--color-primary-50, #FFF0F0)' : (hoveredSortOption === option ? 'var(--color-neutrals-8, #FCFCFD)' : 'none'), border: 'none', textAlign: 'left', fontFamily: 'var(--font-body, Geist, sans-serif)', fontSize: isMobile ? '13px' : 'var(--font-size-sm, 14px)', fontWeight: isActive ? 600 : 400, color: isActive ? 'var(--color-primary-500, #E90C17)' : 'var(--color-neutrals-2, #23262F)', cursor: 'pointer', transition: 'background-color var(--transition-fast, 150ms ease-in-out)', display: 'block' });
  ...
  const categoryRatingsStyle: React.CSSProperties = { display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(2, 1fr)', columnGap: isMobile ? '0' : '48px', rowGap: isMobile ? '16px' : '12px', marginTop: 'var(--spacing-2, 16px)', marginBottom: 'var(--spacing-2, 16px)', paddingTop: 'var(--spacing-2, 16px)', borderTop: '1px solid var(--color-neutrals-6, #E6E8EC)', minWidth: 0 };
  const categoryRatingStyle: React.CSSProperties = { display: 'flex', alignItems: 'center', gap: isMobile ? '8px' : 'var(--spacing-component-md, 12px)', minWidth: 0, overflow: 'hidden' };
  const categoryNameStyle: React.CSSProperties = { fontFamily: 'var(--font-body, Geist, sans-serif)', fontWeight: 400, fontSize: isMobile ? '13px' : 'var(--font-size-xs, 12px)', lineHeight: '1.375em', color: 'var(--color-neutrals-1, #141416)', minWidth: isMobile ? '100px' : 0, flexShrink: isMobile ? 0 : 1, whiteSpace: isMobile ? 'nowrap' : undefined };
  const categoryStarsStyle: React.CSSProperties = { display: 'flex', alignItems: 'center', gap: '2px', flex: 1, justifyContent: 'flex-end' };
  const categoryStarStyle: React.CSSProperties = { width: isMobile ? '14px' : '16px', height: isMobile ? '14px' : '16px', objectFit: 'contain', flexShrink: 0 };
