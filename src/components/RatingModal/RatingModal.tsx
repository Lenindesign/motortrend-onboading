...
export const RatingModal: React.FC<RatingModalProps> = ({
  ...
  const titleStyle: React.CSSProperties = { fontFamily: 'var(--font-heading)', fontWeight: 700, fontSize: '14px', lineHeight: 1.4, color: '#FFB74D', margin: 0, textTransform: 'uppercase', letterSpacing: '2px' };
