...
export const CommunitySidebar: React.FC<CommunitySidebarProps> = ({ communities, onJoinToggle, onCreateCommunity }) => {
  ...
  const verifiedIconStyle: React.CSSProperties = { marginLeft: '6px', color: '#186CEA', flexShrink: 0, display: isCollapsed ? 'none' : 'flex', alignItems: 'center', justifyContent: 'center' };
